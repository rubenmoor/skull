...
, pwstore-fast, servant, servant-purescript_0_8_0_0, servant-server
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    product-profunctors pwstore-fast servant servant-purescript_0_8_0_0
  ...
  executableHaskellDepends = [
    ...
    purescript-bridge servant servant-purescript_0_8_0_0 servant-server
